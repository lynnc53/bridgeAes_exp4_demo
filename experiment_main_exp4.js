...
export async function run({ assetPaths, input = {}, environment, title, version }) {
  ...
  ` ,
    ...
    timeline.push({
      ...
      <p>Then, you will be ask to rate the image on <b>aesthetic pleasure</b>, <b>complexity</b>, <b>interest</b>, <b>perceived safety</b>, and <b>familiarity</b>.</p>
    ...
    var prototypicality_trial = {
        ...
        stimulus: jsPsych.timelineVariable('stimulus'),
        stimulus_width: 800,
        prompt: "<p>I find this image to be representative of its bridge type.</p>",
        choices: rating_scale,
        data: {
    ...
    var rating_procedure = {
        timeline: [if_node, preload_block, aesthetic_trial, complexity_trial, interest_trial, safety_trial, recognition_trial, prototypicality_trial],
